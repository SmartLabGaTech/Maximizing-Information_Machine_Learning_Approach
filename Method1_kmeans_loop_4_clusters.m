...
for l = 1:n_loops
    ...
    figure(11)
    clf
    plot(v_dc(1:steps_loop), mean(mixed_masked_1_mean(cycle, :)),'r.-','LineWidth',1,'MarkerSize',20)
    hold on
    plot(v_dc(1:steps_loop), mean(mixed_masked_1_mean_w(cycle, :)),'black.-','LineWidth',1,'MarkerSize',20)
    xlim([-10, 10])
legend('Read',' Write', 'Location','best')
    legend boxoff
    xlabel('DC voltage [V]')
    ylabel('Average Mixed piezoresponse [a.u.]')
    set(gca, 'FontSize', 12)
    ...
    figure(21)
    clf
    plot(v_dc(1:steps_loop), mean(mixed_masked_2_mean(cycle, :)) ,'r.-','LineWidth',1,'MarkerSize',20)
    hold on
    plot(v_dc(1:steps_loop), mean(mixed_masked_2_mean_w(cycle, :)),'black.-','LineWidth',1,'MarkerSize',20)
    xlim([-10, 10])
legend('Read',' Write', 'Location','best')
    legend boxoff
    xlabel('DC voltage [V]')
   ...
   %Type 3
    ...
    figure(31)
    clf
    plot(v_dc(1:steps_loop), mean(mixed_masked_3_mean(cycle, :)),'r.-','LineWidth',1,'MarkerSize',20)
    hold on
    plot(v_dc(1:steps_loop), mean(mixed_masked_3_mean_w(cycle, :)),'black.-','LineWidth',1,'MarkerSize',20)
    xlim([-10, 10])
legend('Read',' Write', 'Location','best')
    legend boxoff
    xlabel('DC voltage [V]')
    ...
    figure(41)
    clf
    plot(v_dc(1:steps_loop), mean(mixed_masked_4_mean(cycle, :)),'r.-','LineWidth',1,'MarkerSize',20)
    hold on
    plot(v_dc(1:steps_loop), mean(mixed_masked_4_mean_w(cycle, :)),'black.-','LineWidth',1,'MarkerSize',20)
    xlim([-10, 10])
legend('Read',' Write', 'Location','best')
    legend boxoff
    xlabel('DC voltage [V]')
